...
{    
    ...
    public class CompaniesHouseNameSearchResponseDto : ICompaniesHouseResponseDto
    {
        public CompaniesHouseNameSearchResponseDto() { }
        ...
        public ResponseNameSearchBodyDto Body { get; set; }

        public ResponseTypeDto GetResponseType()
        {
            return ResponseTypeDto.NameSearch;
        }
