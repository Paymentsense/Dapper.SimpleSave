namespace PS.Mothership.Core.Common.Constants
{
    public class ConfigurationConstants
    {
        ...
        // Common DueDil Constants
        public const string DueDilUserApiKey      = "DueDilUserApiKey";
        public const string DueDilBaseUrl         = "DueDilBaseUrl";
        public const string DueDilSearchUrl       = "DueDilSearchUrl";
