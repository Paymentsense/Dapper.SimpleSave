...
namespace PS.Mothership.Core.Common.Template.Usr
{
    ...
    [DataContract]
    public enum UsrLoginResultEnum : int
    {
       ...
       [Description("Password failed")][EnumMember]FailedPasswordOnPasswordReset = 12,
    ...
    public class UsrLoginResult
    {
		...
		public int LoginResultKey {get;set;}
            ...
            get
            {
                ...
                {   
                        _list = new List<UsrLoginResult>
                        {
							...
							{
								EnumValue = 12,
								EnumName = "FailedPasswordOnPasswordReset",
								EnumDescription = "Password failed",
								LoginResultKey = 12,
								RecStatusKey = (GenRecStatusEnum)1
							},
